# Quickstart example with inline commentary.
...
# Choose a set of water types (all at ~520 nm).
waters = [
...
# BER snapshot at 10 m across water types.
plt.figure()
for w in waters:
